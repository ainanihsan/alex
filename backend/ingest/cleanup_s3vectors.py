...
def delete_all_vectors():
    ...
    try:
        ...
        if deleted_count > 0:
            print(f"\n[OK] Successfully deleted {deleted_count} vectors")
        else:
            print("[OK] No vectors found - database is already empty")
...
def main():
    ...
    response = input("[WARNING]  This will DELETE ALL vectors. Continue? (yes/no): ")
